...
tailwind.config = {
    theme: {
        extend: {
            ...
            colors: {
                sober: {
                    900: '#121212', // Fondo principal muy oscuro
                    800: '#1e1e1e', // Fondo secundario
                    300: '#d4d4d8', // Texto secundario
                    100: '#f4f4f5', // Texto principal
                    accent: '#8c7e6a' // Un tono dorado/arena apagado para detalles
                }
            }
        }
    }
...
lucide.createIcons();
        ...
        function changeLanguage(lang) {
            ...
            // 2. Actualizar el estilo de los botones del menú de idioma
        ...
        /* --- RESTO DEL CÓDIGO (Navegación, Menú y Galería) --- */
        ...
        function openLightbox(element) {
            if (galleryItems.length === 0) { galleryItems = Array.from(document.querySelectorAll('.gallery-item')); }
        ...
        lightbox.addEventListener('click', (e) => {
            if (e.target === lightbox || e.target.parentElement === lightbox || e.target.tagName.toLowerCase() === 'div' && e.target !== lightboxImg) {
                closeLightbox();
            }
        });
